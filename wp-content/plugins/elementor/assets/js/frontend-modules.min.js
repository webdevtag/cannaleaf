    ...
    169: (e, t, r) => {
      ...
      var n = r(4762),
        ...
        b = (e.exports = function (e, t, r) {
          ...
          var n = d(e);
          return (
            o(n, "source") || (n.source = v(_, "string" == typeof t ? t : "")),
            e
          );
        });
                ...
                e.addedNodes.forEach((e) => {
                  if (1 === e.nodeType)
                    if (e.matches && e.matches(s))
                      ...
                      (e.querySelectorAll ? e.querySelectorAll(s) : []).forEach(
                        (e) => {
                          e.addEventListener("click", (e) => {
                            this.handleTopBarClick(e);
                          });
    ...
    1506: (e, t, r) => {
      ...
      e.exports = function (e, t, r) {
        var g,
          ...
          callFn = function (e) {
            return E
              ? (s(e), T ? x(e[0], e[1], stop) : x(e[0], e[1]))
              : T
              ? x(e, stop)
              : x(e);
          };
          ...
          document.addEventListener(
            ...
            document.addEventListener("change", (e) => {
              ...
              o &&
                ...
                this.trackControl(o, n.CONTROL_TYPES.SELECT);
            });
        }
          ...
          if (a && "string" == typeof a) {
            const e = a
              ...
              .filter(
                (e) =>
                  e &&
                  !e.startsWith("elementor-control-") &&
                  !e.startsWith("wp-")
              )
              .slice(0, 3);
